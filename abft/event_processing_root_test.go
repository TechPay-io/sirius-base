...
func TestSiriusClassicRoots(t *testing.T) {
...
func TestSiriusRandomRoots(t *testing.T) {
	// generated by codegen4SiriusRandomRoot()
	testSpecialNamedRoots(t, `
 A1.01    
 ║         ║        
 ╠════════ B1.01    
...
func testSpecialNamedRoots(t *testing.T, scheme string) {
	...
	// init abft
	lch, _, input := FakeSirius(nodes, nil)
...
/*
// codegen4SiriusRandomRoot is for test data generation.
func codegen4SiriusRandomRoot() {
	nodes, events := inter.GenEventsByNode(4, 20, 2, nil)

	p, _, input := FakeSirius(nodes)
	// process events
	config := inter.Events{}
