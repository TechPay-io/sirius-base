Please check if what you want to add to `sirius-base` list meets [quality standards](https://github.com/TechPay-io/sirius-base/blob/master/CONTRIBUTING.md#quality-standard) before sending pull request.
